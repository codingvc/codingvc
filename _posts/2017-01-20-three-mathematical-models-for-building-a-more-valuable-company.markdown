...
3. In the third model, there are many milestones that can be achieved in parallel or that do not depend on each other. For example, you can build a sales team and explore marketing channels at the same time, and making progress on either goal will provide your company's valuation.